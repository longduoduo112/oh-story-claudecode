...
- [ ] “收一个”：本章偿还了哪笔期待债，或以什么进展/收益/反馈支付了利息
- [ ] “开一个”：本章留下了什么有意义的下一步（问题/决定/行动/关系变化/阶段目标/情绪余势）
...
### 章尾
- [ ] 结尾落在变化上
- [ ] 有危机/决定/行动/发现/关系变化/阶段目标/情绪余势中的至少一个；低压章不强求硬悬念
- [ ] 不是总结式结尾
- [ ] 拉住读者翻下一页
- [ ] 钩子诚信：下一章能真实承接，不撤回、不降格成误会、不切线逃债
- [ ] 强反转/爆点只在结构节点使用且有铺垫，没有为了“章章炸”临时加码

### 语言
- [ ] 没有空洞的抒情段落
- [ ] 没有连续多段同一情绪
- [ ] 对话符合人物身份（不同人说话方式不同）
- [ ] 标点节奏符合语气和人物声线：没有通篇句号化，也没有随机堆砌问号/感叹号；正文（含对话）的 `……`/`——` 均有可说明的吞咽、未尽、截断、拖音或声线功能，无功能复现已改为动作、短句、逗号或句号
- [ ] 情绪通过动作落地（不是直接说"他很难过"）
- [ ] 标题行以外没有章节/写作元信息：不得出现 `第[一二三四五六七八九十百千万两0-9]+章|上一章|上章|前一章|本章|这一章|前文|后文|伏笔|细纲|读者|ch\d+ 等英文章号缩写` 这类词；需要承接前文时改成角色能感知的事件锚点或相对时间；故事内真实阅读/讨论“第X章”或真实读者身份语境除外
