...
| 题材 | 核心机制 | 与相邻题材的区别 | 入口 |
|---|---|---|---|
| 地下城核心 | 固定核心通过资源取舍、建设和外部反馈扩张 | 不是普通领地经营；主角不能自由移动 | `genre-prose-cards/地下城核心.md` |
| 温馨奇幻 | 社区、手艺、关系和生活空间持续改善 | 不是无冲突日常；状态变化替代生死刺激 | `genre-prose-cards/温馨奇幻.md` |
| 爬塔升级 | 独特楼层规则构成连续中型剧情单元 | 不是重复刷副本；探索必须参与破局 | `genre-prose-cards/爬塔升级.md` |
| 数值冒险 | 数值、技能、装备和构筑形成稳定因果 | 不是电竞比赛；规则一致性高于公开胜负反馈 | `genre-prose-cards/数值冒险.md` |

四类题材均先读 `genre-contracts.md`，再进入 Phase 2 题材契约物化和 Phase 3 大纲。
