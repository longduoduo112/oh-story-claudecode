...
assert len(skills) == 18, f'expected 18 skills, got {len(skills)}'
assert len(commands) == 18, f'expected 18 commands, got {len(commands)}'
...
PY
echo "  OK 18 Skills + 18 Commands (schema and one-to-one names)"
